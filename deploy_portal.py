...
CONTRIBUTE_PORT = int(os.environ.get("VOLUSIA_CONTRIBUTION_PORT", "8790"))
LISTEN_PORT = int(os.environ.get("VOLUSIA_PROXY_PORT", "80"))
...
def main():
    ...
    print("  http://localhost/project-volusia — Portal")
    print("  http://localhost/data-explorer — Data Explorer")
